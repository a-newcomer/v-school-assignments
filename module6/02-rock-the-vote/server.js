...
app.use('/api', expressJwt( {secret: process.env.SECRET, algorithms: ['sha1', 'RS256', 'HS256'] })) //This add req.user to the req body, the first step in connecting authorization to our other routes
